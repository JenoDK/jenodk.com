...
export const skills: Skill[] = [
  ...
  { name: 'Cypress', category: 'frontend', level: 'advanced' },
  ...
  { name: 'CloudFormation', category: 'cloud', level: 'advanced' },
